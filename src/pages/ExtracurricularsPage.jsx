...
const images = {
  Debate: 'https://images.unsplash.com/photo-1546410531-bb4caa6b424d?auto=format&fit=crop&w=800&q=82',
  Sports: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?auto=format&fit=crop&w=800&q=82',
  Academic: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=800&q=82',
  Service: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=800&q=82',
}
const opportunities = [
...
export default function ExtracurricularsPage() {
  ...
  const enter = (delay = 0) => ({ initial: reducedMotion ? false : { opacity: 0, y: 18 }, whileInView: reducedMotion ? {} : { opacity: 1, y: 0 }, viewport: { once: true, amount: .16 }, transition: { duration: .5, delay, ease: [0.16, 1, .3, 1] } })
  return <main className="opportunity-page">
    <section className="opportunity-hero" aria-labelledby="opportunity-heading">
      <motion.div className="opportunity-hero-copy" initial={reducedMotion ? false : { opacity: 0, y: 20 }} animate={reducedMotion ? {} : { opacity: 1, y: 0 }} transition={{ duration: .65, ease: [0.16, 1, .3, 1] }}><p className="opportunity-eyebrow">The opportunity board</p><h1>Find the room<br />where you <em>belong.</em></h1><p>Competitions, service, sports, and academic experiences curated by Flamivor students for the next thing you want to try.</p></motion.div>
      <motion.figure className="opportunity-hero-image" initial={reducedMotion ? false : { opacity: 0, scale: .96 }} animate={reducedMotion ? {} : { opacity: 1, scale: 1 }} transition={{ duration: .7, delay: .1, ease: [0.16, 1, .3, 1] }}><img src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1200&q=84" alt="Students gathering outdoors" fetchPriority="high" /><figcaption>Open calls / updated 2026</figcaption></motion.figure>
    </section>
