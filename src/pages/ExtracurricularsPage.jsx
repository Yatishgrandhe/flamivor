...
export default function ExtracurricularsPage() {
  ...
  return <main className="opportunity-page">
    <section className="opportunity-hero" aria-labelledby="opportunity-heading">
      ...
      <motion.figure className="opportunity-hero-image" initial={compactMotion ? false : { opacity: 0, scale: .96 }} animate={compactMotion ? {} : { opacity: 1, scale: 1 }} transition={{ duration: .7, delay: .1, ease: [0.16, 1, .3, 1] }}><img src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1200&q=84" alt="Students gathering outdoors" fetchPriority="high" /><figcaption>Open calls / updated 2026</figcaption></motion.figure>
    </section>
